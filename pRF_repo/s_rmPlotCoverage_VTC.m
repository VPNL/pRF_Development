...
if strcmpi(varargin{1},'dialog')
    ...
    for ii = 1:2:length(varargin)
        switch lower(varargin{ii})
            ...
            case 'sigmathresh' ,    vfc.sigmathresh     = varargin{ii+1}; % integer
        end
    end
end
...
% Find voxels which satisfy cothresh and eccthresh and sigma thresh.
coIndices = co>vfc.cothresh & ...
    ecc>=vfc.eccthresh(1) & ecc<=vfc.eccthresh(2) & sigma1>vfc.sigmathresh;
if ~any(coIndices)
